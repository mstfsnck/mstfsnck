...
public class C09_equals {
    public static void main(String[] args) {
        ...
        System.out.println("list1.equals(list2) = " + list1.equals(list3)); // list1.equals(list3) = true
        System.out.println("list1.equals(list2) = " + list1.equals(list4)); // list1.equals(list4) = false
