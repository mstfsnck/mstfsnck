...
public class C05_Arrays {
    public static void main(String[] args) {
        ...
        System.out.println("Arrays.toString(yeniArr) = " + Arrays.toString(yeniArr)); // Arrays.toString(yeniArr) = [84, 72, 63, 3, 39, 55, 66, 654, 85, 35, 0, 0, 0, 0, 0]
        ...
        // fill methodu update icin kullanilir
